...
//func testProduceConsume(t *testing.T, client api.Log.LogClient, config *Config) {
func testProduceConsume(t *testing.T, client, _ api.Log.LogClient, config *Config) {
